...
def get_args():
    ...
    # DCNv3 
    parser.add_argument('--num_deep_cross_layers', type=int, default=4, help='Number of deep cross layers in DCNv3')
    parser.add_argument('--num_shallow_cross_layers', type=int, default=5, help='Number of shallow cross layers in DCNv3')
    parser.add_argument('--deep_net_dropout', type=float, default=0.2, help='Dropout for deep net in DCNv3')
    parser.add_argument('--shallow_net_dropout', type=float, default=0.2, help='Dropout for shallow net in DCNv3')
    ...
    # MLP 
    parser.add_argument('--mlp_hidden_layers', type=str, default='128,64,32', help='Comma-separated hidden layers for MLP (e.g., 128,64,32)')
