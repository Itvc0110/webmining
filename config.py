...
def get_args():
    ...
    parser.add_argument('--embed_dim', type=int, default=16, help='Embedding dimension for users and items')
    ...
    parser.add_argument('--num_shallow_cross_layers', type=int, default=4, help='Number of shallow cross layers in DCNv3')
    parser.add_argument('--deep_net_dropout', type=float, default=0.1, help='Dropout for deep net in DCNv3')
    parser.add_argument('--shallow_net_dropout', type=float, default=0.1, help='Dropout for shallow net in DCNv3')
    ...
    # DeepFM 
    parser.add_argument('--deepfm_hidden_layers', type=str, default='32,32', help='Comma-separated hidden layers for DeepFM DNN (e.g., 32,32)')
    
    # MLP 
    parser.add_argument('--mlp_hidden_layers', type=str, default='64,32', help='Comma-separated hidden layers for MLP (e.g., 64,32)')
